var StateStorage = /*#__PURE__*/function () {
  ...
  var _proto = StateStorage.prototype;

  _proto.read = function read(location, key) {
    var stateKey = this._getStateKey(location, key);

    try {
      var value = window.sessionStorage.getItem(stateKey); // === null is probably sufficient.
  ...
  _proto._getStateKey = function _getStateKey(location, key) {
